"""
v7 Move-C probe (folded into Paper XVI sec 2 as a scoping caveat)  --  p18_seal_divisibility.py
[NOTE: the "p18" filename is a historical accident of the aborted Move-C numbering;
 this receipt does NOT belong to Paper XVIII (the chiral-gap paper, receipts pD*/pB*).]
