#!/usr/bin/env python3
"""
dimwall_manifoldweb.py — v9 round 45: the grown channel-manifold web
(pin: note-3p1-manifoldweb, dd76265, strictly before this ran).
...
# ---- the grown builder ----
def build_manifold(sd, K, alpha, C_dirs=None, N=2048, M=32, L=16,
                   D=1024, NW=256):
    """Direction-valued deposits: slot s has preferred direction p_s;
    a click draws u = p_s w.p. alpha else uniform(S^2); the K clocks
    advance by e*max(0, u.v_k). Per-clock churn."""
