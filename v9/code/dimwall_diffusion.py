...
print("[diffusion churn — round 48; NO-REVIEW, lean]")
...
import builtins
for g, seeds, tag in ((0.0625, range(20264000, 20264010), "main"),
                      (0.25, range(20264100, 20264105), "fast")):
    builtins.G_LEAK = g
    globals()['G_LEAK'] = g
...
counts = []
for sd in (20264200, 20264201, 20264202):
