...
## 2026-08-16 — v15 OPENS: WAVE 1 LAUNCHED (v15 LEDGER #1)

User review complete; rulings: launch order = parallel
THEORY-CONTRACT + ARITY + DISCRIMINATOR with AUTOGLUE,
EXCITATION (paper-46) SEQUENTIAL after AUTOGLUE's verdict;
CR-B/C/D and LOR-B RETIRED.  Four pins frozen
(note-contract-pin, note-arity-pin, note-autoglue-pin,
note-disc-pin); constructions launch on this commit.
Registry discipline in force: pins cite question numbers;
