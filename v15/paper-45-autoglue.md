# Can the crossing declare its own seam?

**AUTOGLUE / paper-45.** Pin `v15/note-autoglue-pin.md` (FROZEN, sha256-12
`88c04df52c19`). Code `v15/code/autoglue_exact.py`; artifacts
`v15/code/autoglue_output.txt`, `v15/code/autoglue_receipt.json`.
Questions Q38, Q39, Q40, with the Q34 seed and Q41, Q42, Q50.
...
own form at every reading taken.

## 2. The arena, declared as data (RUNBOOK section 15)

| row | value |
|---|---|
| boundary | the cells of two AG(2,3) charts with three declared link directions, plus whatever cells the update makes |
| family | the 455 three-actor conflict groups of the aligned k = 3 union |
| law | the co-division relation of the saturating arrangement, I7's readout, HA's admissibility, the weld's three legs |
| state | the completion of the seam's four undetermined entries, at each of the 3 shared sites |
| arena axes | the five declared window axes: creation, reading, count leg, form carry, state |
| provenance | 6 sources read at pinned shas at commit ba62eac |
...
### 2.2 The update window, named

The window is the axes along which an update may be varied, and it is fixed
before anything is measured.

| axis | members | the delivered value |
|---|---|---|
| CREATION | NONE, CROSS-ONLY, WITHIN-ONLY, ALL-NEW | NONE |
...
|---|---|---|---|
| NONE | 54 | 0 | 401 |
| CROSS-ONLY | 270 | 216 | 185 |
| WITHIN-ONLY | 167 | 0 | 288 |
| ALL-NEW | 455 | 288 | 0 |

Read the second row first. **CROSS-ONLY reaches 216 of 288.** That is the
parent's number, and this unit's instrument does not type it: it parses it
...
**NONE is the parent's frozen geometry and it refuses every crossing.** All
288, exhaustively; and it still admits 54 events, the ones that cross
nothing and open no new pair. The detector is not a machine that kills
whatever it is handed.

**ALL-NEW admits everything, and that is its price rather than its**
**success.** A rule that absorbs every new pair keeps the geometry's
incidence equal to the record's support at every step, so the identity is a
weld map forever and no record can ever fail. The refusals fall from 401 to
...
The chart breaks a symmetry the relation does not, so nothing here is taken
at an orbit representative: all 455 events are censused object by object.

| profile (cross, within, doubled) | successors | of those, already declared | form-lawful | state may stay | events |
|---|---|---|---|---|---|
| [0, 0, 3] | [103, 31, 31] | [31, 31, 31] | True | True | 4 |
| [0, 0, 3] | [31, 103, 31] | [31, 31, 31] | True | True | 4 |
| [0, 0, 3] | [31, 31, 103] | [31, 31, 31] | True | True | 4 |
| [0, 0, 3] | [31, 31, 31] | [31, 31, 31] | True | True | 12 |
| [0, 0, 3] | [31, 31, 49] | [31, 31, 31] | True | True | 10 |
| [0, 0, 3] | [31, 49, 31] | [31, 31, 31] | True | True | 10 |
| [0, 0, 3] | [49, 31, 31] | [31, 31, 31] | True | True | 10 |
| [0, 1, 2] | [103, 31, 31] | [31, 31, 31] | False | False | 2 |
| [0, 1, 2] | [31, 103, 31] | [31, 31, 31] | False | False | 2 |
| [0, 1, 2] | [31, 31, 103] | [31, 31, 31] | False | False | 2 |
| [0, 1, 2] | [31, 31, 31] | [31, 31, 31] | False | False | 48 |
| [0, 1, 2] | [31, 31, 49] | [31, 31, 31] | False | False | 16 |
| [0, 1, 2] | [31, 49, 31] | [31, 31, 31] | False | False | 16 |
| [0, 1, 2] | [31, 49, 49] | [31, 31, 31] | False | False | 2 |
| [0, 1, 2] | [49, 31, 31] | [31, 31, 31] | False | False | 16 |
| [0, 1, 2] | [49, 31, 49] | [31, 31, 31] | False | False | 2 |
| [0, 1, 2] | [49, 49, 31] | [31, 31, 31] | False | False | 2 |
| [0, 3, 0] | [31, 31, 31] | [31, 31, 31] | False | False | 5 |
| [1, 0, 2] | [4, 8, 8] | [0, 8, 8] | True | False | 27 |
| [1, 0, 2] | [8, 4, 8] | [8, 0, 8] | True | False | 27 |
| [1, 0, 2] | [8, 8, 4] | [8, 8, 0] | True | False | 27 |
| [1, 0, 2] | [8, 8, 8] | [8, 8, 8] | True | True | 27 |
| [2, 0, 1] | [0, 4, 4] | [0, 4, 4] | False | False | 36 |
| [2, 0, 1] | [4, 0, 4] | [4, 0, 4] | False | False | 36 |
| [2, 0, 1] | [4, 4, 0] | [4, 4, 0] | False | False | 36 |
| [2, 1, 0] | [0, 0, 0] | [0, 0, 0] | False | False | 72 |

The three columns to read together are the profile, the successors, and
form-lawful. A profile is the event's footprint: how many of its three
...
### 4.2 What kind of law this is: a transition relation
...
| successors of the whole state | crossings |
|---|---|
| 256 | 81 |
| 512 | 27 |

256 successors at 81 of the lawful crossings and 512 at the other 27. **What the update delivers is a transition relation, a state**
**together with an event mapping to a SET of lawful successors, and not an**
**evolution law, deterministic or otherwise.** Nothing in this unit licenses
calling it either.
...
reading this unit declares and measures, not a fact it found.
...
### 4.4 What a state declared in advance is ready for

If the state must precede the event, the honest question is how much of the
future one declaration can cover. A completion predicts a count for every
cross direction of its seam; a crossing can be realised, with the single
incidence one event deposits, exactly where that prediction is 1. So each
of the 29791 states the arena admits is ready for a definite set of the 108
crossings, and the census is exhaustive over the state space.

| crossings the state absorbs | states |
|---|---|
| 0 | 20100 |
| 1 | 6804 |
| 2 | 2034 |
...
|---|---|---|---|
| refutability: events the weld refuses | 401 | 293 | PART SPENT |
| forcing: free items at a lawful crossing | 0 | 3 | SPENT |
...
other extremal principle, is DERIVABLE rather than newly declared. The
attempt is made against eight declared functionals, before the event and
after it.

| functional | selects before | selects after, least | selects after, most | the direct sum before |
|---|---|---|---|---|
| maximum determinant | 1 | 4 | 4 | True |
| minimum determinant | 12 | 4 | 4 | False |
| minimum cross coupling | 1 | 1 | 4 | True |
| maximum cross coupling | 2 | 1 | 4 | False |
| minimum two-sided price | 31 | 8 | 8 | True |
| minimum one-sided price | 8 | 1 | 8 | False |
| maximum one-sided price | 8 | 1 | 8 | False |
| maximum realisable crossings | 12 | 4 | 4 | False |

The parent's sentence is quoted into the gate that measures this:
...
The pin asked, if the answer were no, for

> the obstruction theorem (which datum must precede the event

proven over the whole window rather than exhibited at a case. Here it is,
and it is checked at every object of that window.

**THE DATUM IS THE SEAM'S CROSS BLOCK.** The incidence a crossing needs it
creates; the form it needs it cannot. Three measurements make the theorem,
each exhaustive over the arena:
...
multivalued; no metrical reading of it is taken here.
...
rule, and the synthesis of those with this one is handed, explicitly and
unattempted here, to DYNAMICS-CLOSURE.

**THE ALLOWED EVENTS.** A conflict group is allowed at a state when the
transition below leaves every delivered leg intact. Which events those are
...
- the RECORD takes the event's three incidences, each pair's count rising
  by one;
...
equivalence class this arena does not select within; anything that turned on
the choice between them would be unmeasured here.
...
crossings; all three legs together at 108,
and at 162 events in all. Nothing here licenses the rule at another arity,
another arena, another arrangement or another readout; nothing here licenses
...
which the seam's system is not underdetermined, which is a question about
a, q and the arrangement, and therefore a question for the unit that varies
them.

## 8. The walls

**No update measured here is claimed to be the theory.** Every rule in the
window is a declaration, priced; the surviving one is a candidate universal
...
does not occur here, and the gate that enforces its absence
...
No measure is declared on the event family, on the state space or on the
completion lattice. Every ratio in this paper is a count over an exhaustive
enumeration with its denominator beside it, and it is stamped
counting-only in the receipt. The event profiles differ in size by more
than an order of magnitude, and nothing here may be read as how often a
crossing is lawful.
...
|---|---|---|---|
| the base object: the aligned k = 3 union of two driven sectors | forced | 1 | inherited at the parent's pinned sha |
| the link-creation rule | declared, the axis | 4 | M1, every member run at every event |
| the reading and the count leg | held at the delivered values | 4 | M1, all four cells run |
| the readout carried to created cells | declared, MEASURED VERDICT-BEARING | 2 | M2: dropping it admits every event, carrying it admits 162 |
...
than 9 of the 108 crossings, and the corpus carries no law that chooses
among what is left. Motivation, meanwhile, turns out to live exactly where
the dynamics cannot go.
