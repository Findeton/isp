# v14 LOG — THE LIMIT PROGRAM (append-only ledger)

Charter: v14/PLAN.md (`7a40eeea0df3`, recorded v13 #315).
Predecessor: v13 CLOSED AND FROZEN at #320 (4ac4f76).
Discipline: RUNBOOK §13/§14/§15 + all addenda; papers numbered
(paper-NN-<slug>.md, NN at pin time); inheritance by hash-pin only.

## 2026-08-09 — R0: THE FOUNDING PIN FROZEN (v14 LEDGER #1)
note-r0-founding-pin.md (`e9d2bedff244`) committed.  The
seven-row inheritance hash-pinned (I1 master equation 85f3cf809544;
I2 spectral carry + the theorem wall, same receipt; I3 topology base
w/ TRIVIAL H₁ 65bb1fc5231f; I4 successor requirements
e4934f2525b0/31b70406c6e8; I5 the scale FACTS w/ the
thesis-retirement clause 3e502f685ab3; I6 the tower + the one law
c9bc956fe751/e0b2f444f6a9/7c7b91a9257e; I7 gravity's record layer
542b8735daf0).  Anything of v13 not listed = HISTORY, not base.
**R1 — THE CONTINUUM RUNG — posed**: does a DECLARED refinement
family admit a PRE-REGISTERED intensive invariant that stabilizes?
...
## 2026-08-09 — R1 DELIVERED, COMMITTED AS-IS (v14 LEDGER #3)
paper-01-continuum-rung.md (2c75772098eb) + r1_continuum_
exact.py (7c04500ec178) + _output.txt (624ab5236ea1) +
_receipt.json (2130abe58b9e) committed exactly as delivered
BEFORE adjudicator verification.  **THE VERDICT AS EMITTED:
R1-STABILIZES-AT-<NCOH_DENSITY=37/27;B2_DENSITY=20/37 |
DIVERGENT=PHI:STRICTLY-DECREASING;SPECTRAL_PROFILE:SUPPORT-
CONSTANT-WEIGHTS-MOVING;DIMENSION_PROFILE:SUPPORT-CONSTANT-
WEIGHTS-MOVING | WINDOW=K=3-OF-5-MEMBERS-NO-CAP |
FUNCTORIALITY=FAMILY-NON-FUNCTORIAL-AT-2-OF-4-STEPS |
R2-GATEWAY=A1>.**  The family: A₁ 9 / A₂ 16 / A₃ 43 / A₄ 50 /
A₅ 57 labels, NO CAP, every size DERIVED (generator rule
extracted as data from the pinned I2 receipt: L_m = 7m+1,
gated to reproduce all 28 scale-threshold cells; width
cross-anchored to I6).  **TWO REGISTERED INTENSIVE INVARIANTS
STABILIZE EXACTLY: N_coh density = 37/27 and b₂ density =
20/37, constant on A₃/A₄/A₅ AND at the index-robustness
probes L₁₀ (71 labels) and L₁₂ (85 labels).**  THE MECHANISM
MEASURED, NOT INFERRED: b₀(N) = blocks+1 at every member —
the rule refines by DISJOINT ADDITION with per-block counts
equal across A₃–A₅ (27 one-cells / 37 coherent 2-cells per
block); per-cell densities survive exactly that, label-
normalised quantities dilute via the lone basepoint.
**LOCALITY EVERYWHERE: φ < 1 at ALL FIVE members (7/9, 1/4,
6/43, 3/25, 2/19, strictly decreasing) — the computed R2
gateway is A₁.**  FAMILY-NON-FUNCTORIAL measured at 2/4 steps
(A₁→A₂ BLOCK-WIDTH-DECREASES 8>5; A₂→A₃ ORBIT-SIZE-
UNAVAILABLE) — the family is heterogeneous before A₃,
homogeneous from A₃ on; the stabilisation lives on the
homogeneous tail.  b₁(N)=0 at every member (I3's trivial H₁
reproduced).  Scramble control: moves exactly
{NCOH_DENSITY→0, B2_DENSITY→UNDEFINED (denominator vanishes,
recorded as measured)}, fixes {PHI, both profiles} — the
pin's declared split.  Controls positive/negative/
discrimination all correct.  Counts: 60 anchors, 33 gates
all must-pass, 4 disclosures, 47/47 mutants dead no
tracebacks, never-falsified EMPTY, 177 measured data.
Two plain runs byte-identical; selftest writes nothing (CLI
contract in header).  Compliance sweep: every §13/§14/§15
rule + all 2026-08-09 addenda walked, incl. the boundary-
parity gate w/ a degenerate probe as death certificate.
Declared limitation stated in paper §12: the atlas is this
