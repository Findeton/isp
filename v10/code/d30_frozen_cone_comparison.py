...
if branch == 3:
    ...
    print("      — concordant between the MM inversion and midpoint scaling")
    print("      (2^-1.756, review-verified), stable across intervals and N at")
    print("      tested scale, and STRONGLY EXCLUDED as a filament or as M^2")
    print("      by the registered finite-sample diagnostics (occupancy/width")
    print("      profiles; no argmax bias). SCOPE: an EFFECTIVE-ORDER result —")
    print("      the estimator is card-certified on integer-d sprinklings")
    print("      only; and with the spatial row vacant, this arc has measured")
    print("      the order geometry of a particular event DAG, NOT an emergent")
    print("      spatial metric or light cone. The sharpened F12 question is")
    print("      quantitative: what opportunity structure moves d_hat -> 2,")
    print("      and is d_hat(kernel) continuous in the kernel parameters?")
