...
check("C5 [CORRECTED BY ROUND 1 — MAJOR 3] 'ABOVE THE SPRINKLING FLOOR "
      ...
      f"brick DOES reach |D| >= 4 ({A1[3]['h4']}), inside the d = 3 "
      "sprinkling band — so the width shortfall is a d = 2 statement, "
      "exactly as the homogeneity ordering is (C3).  The unit's own "
      "'the brick is 1+1-thin by design' was honest; what was missing "
      "is this comparison, which D58 had computed and never printed",
