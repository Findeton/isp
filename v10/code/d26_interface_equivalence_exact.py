...
# E6: the survivor structure + measured inputs (prints; post-round-1 wording)
print("      E6 THE SURVIVOR STRUCTURE AT THE DECLARED INTERFACE (current lab/")
print("      collider/solar-system + current cosmological/coherence records;")
print("      GIVEN the NSE selection [POSITED], one class under the declared")
print("      epsilon-convention — paper 19 §1/§4):")
print("        { D15 tested-domain restriction (identified, paper 18) }")
print("        x { a neutrino-mass extension at measured inputs [LITERATURE]:")
print("            dm2_21 ~ 7.5e-5 eV^2, |dm2_32| ~ 2.5e-3 eV^2,")
print("            sin2th12 ~ 0.31, sin2th23 ~ 0.55, sin2th13 ~ 0.022;")
print("            minimally dim-5 (Majorana) OR nu_R Yukawas (Dirac) —")
print("            nature / ordering / theta23-octant class-internal }")
print("        x { any dark sector with non-gravitational portals below")
print("            current bounds, entering via its pinned portal (E2/E3) }")
print("        x { any UV completion with the D15 FULL-PROFILE shadow (E1) }")
print("        x { any admissible birth kernel below coherence bounds (E4/E5) }")
print("      THE RECORD ALONE additionally tolerates: sub-bound intrinsic")
print("      collapse (GRW-1986 rate; splitter = the D21 ladder) and MOND/")
print("      AeST-class modified gravity (unadjudicated, F11; splitters =")
print("      low-acceleration / cluster-lensing / cosmological precision).")
print("      SPLITTERS: heavy-sector clicks (E1); portal-coherence precision +")
print("      direct detection (E2/E3); ladder residuals / interferometric")
print("      visibility (E4); 0nubb / JUNO-class ordering / octant data")
print("      (neutrino); cosmological record-count precision (birth kernel)")
print("      [CONSISTENT today, not identified].")
check("E6 survivor structure + splitters printed", True)
