...
WITNESS NUMBERS (solver-tolerance digits FLAGGED):
  ...
  CG-I3322 level-2 (tighter)     =  0.2513863838...   (strict outer-relaxation nesting)
  Q (converged, level>=4)        <= 0.2508754         (Pal-Vertesi 2010, CITED)
  => 0.2514709 (1+AB) > 0.2513864 (lvl2) > 0.2508754 (Q): P* in Q-tilde \\ Q.
...
check("STEP1: strict OUTER-RELAXATION NESTING  1+AB > level2 > Q "
      "(0.2514709 > 0.2513864 > 0.2508754) => 1+AB not yet Q",
