# ISP v17 event ledger

This ledger is append-only. Later corrections do not rewrite earlier entries.

## 2026-08-22 — v17 REALITY-FIRST ERA INITIALIZED (v17 LEDGER #1)

The user authorized v17 as a takeover and scientific reset: pursue a unified
explanation of quantum physics and gravity, retain Barandes's ontological
promise as a hypothesis, scrutinize physical reality rather than extend a toy
for formal convenience, and record/develop the plan before new construction.

The initialization bundle is frozen as planning and scope authority:

| artifact | SHA-256 | size |
|---|---|---:|
| `v17/README.md` | `b67cfca4e16f38996d1a2f1fce40e46cfbed92bfc1c7e8ffeb933d036e0bccda` | 103 LF / 4,690 bytes |
| `v17/paper-00-reality-first-programme.md` | `a4370f71e8af92c0945068ae0dc7d254143ab708f10e9d359f82940e0a6ed82a` | 476 LF / 21,268 bytes |
| `v17/note-v16-scientific-balance-sheet.md` | `fa1be7e5dd865189545315d3c020b29f971147f99779c766ab8dfbeb60a6430f` | 263 LF / 12,976 bytes |
| `v17/note-empirical-quantum-adequacy-contract.md` | `0fe45175f69f103004ef0c97a7be619cbdf3101771f8e6889a012114862889cc` | 437 LF / 17,521 bytes |
| `v17/DECLARED_INPUTS.md` | `70ec7bee2bd7d73ea5466145ce87d7a10de0a4b55cea0e0953fd510c2eda4580` | 92 LF / 6,506 bytes |
| `v17/PLAN.md` | `98d71f28bab24664419e2c1a90c1e90071f0edb7e9b90488c8c51b9e21343a82` | 386 LF / 15,082 bytes |

Scientific reset engraved:

1. v16 Paper 13D is an accepted finite mathematical reference construction,
   not an inherited fundamental law.
2. v16 Paper 14's structural survivor, Paper 15's conditional geometry, and
   Paper 16's declared GR sector are diagnostic controls, not spacetime or
   gravity derived from the accepted law.
3. The Paper 23d correction is binding: an absent latent variable is
   underdetermined, not uniformly weighted; scalar reweighting of an
   orientation-forgetting space does not close state-space extensions.
4. A universal law, contingent state/boundary condition, process occurrence,
   and one actual history are distinct physical categories.
5. No discreteness, graph ontology, selector, preferred clock, dimension,
   topology, metric, or amplitude ontology is preselected.
6. The programme now proceeds from complete quantum empirical adequacy to
   external-time removal, common matter–geometry dynamics, low-energy gravity,
   spacetime status, and empirical discrimination.

Paper 01 is named but not yet pinned. Its target is the complete
finite-dimensional quantum process interface (Q0–Q3), including composition,
Bell/no-signalling, contextuality, multi-time memory, and the
...
## 2026-08-22 — PAPER 03 v3 HYBRID-SEMANTICS PIN FROZEN (v17 LEDGER #46)

The result-neutral repair pin freezes at:
...
The pin repairs exactly the two v2 defects without changing a probability or
physical parameter. Every exact boundary receives a hybrid
classical--quantum observable algebra; a retained-outcome measurement is one
complete normalized CP arrow rather than a branch list or nonselective sum;
adaptive controls, discard, and coarse-graining must compose; and `Ev` and
`Heis` must agree on every complete reader. Standard-Borel retained outcomes
enter only under the named normal-extension/reference-measure hypotheses,
with an honest finite-control fallback.

Concurrency is narrowed to the least congruence generated by certified
commuting squares of complete operations and state/record kernels. All linear
...
## 2026-08-23 — PAPER 03 v3.2 MATHEMATICS GREEN-UNREVIEWED (v17 LEDGER #65)

The sole construction authorized by ledger #64 freezes at:

| artifact | SHA-256 | normalized self-SHA-256 | size |
|---|---|---|---:|
| `v17/paper-03v32-complete-boundary-relativistic-adequacy.md` | `469ae61c849573c9fe7c70871ca6b60843a080082d07f6850b48213b86d6f7d6` | `025f45d51dfba2f380491500bea6e57b831b399a44c987ce1e6f6b72358d68bf` | 1,320 LF / 56,462 bytes |

Status: `GREEN-UNREVIEWED MATHEMATICS`; no scientific coordinate is terminal.
The candidate constructs one complete packet-relative predictive algebra, a
normal predual ensemble state `Ens`, exact five-field paired stochastic/UCP
arrows, closure under finite paths, mixtures, and positive registered
conditioning, and finite plus conditional continuous same-instrument duality.
The continuous theorem retains the old record, uses one common outcome/null
class and one jointly measurable decomposable instrument, lands in the target
algebra, and requires the sample kernel's conditional state barycentre to be
the posterior generated by that same instrument.

The frozen paper explicitly dispositions all 24 theorem targets, C1--C40,
mandatory attacks 1--64, and the 18+18 fresh pin-audit countermodels. It gives
a nontrivial old-record continuous qubit instrument as a domain witness and
keeps generic diffuse point restart, outcome-dependent nonisomorphic fibers,
hidden memory, non-NEP instruments, singular record updates, and uncertified
schedule swaps outside the positive theorem.

The provisional ceiling is
`P03V32-RELATIVISTIC-QUANTUM-OPERATIONAL-ADEQUACY-WITH-GLOBAL-ONTOLOGY-DEBT`.
This is a representation theorem over supplied laboratory and AQFT
comparators, not an ontology, actuality rule, internal clock, spacetime, or
