...
**Status:** PRIVATE DRAFT / NOT FROZEN / NOT AN AUTHORIZED UNIT
...
This pin was drafted after an author-side proof candidate and source audit
already existed:

- `/private/tmp/v17_continuous_cut_information_theorem_candidate.md`;
- `/private/tmp/v17_continuous_cut_source_quantifier_audit.md`.
...
1. **Source fidelity:** the natural-distribution lower bound is reconstructed
   at error \(1/3\) for \(n\in4\mathbb N\).
...
17. HJMR information cost \(I(X,Y:Q)\) replaced without proving conditional
    independence;
...
33. established behavior called a new empirical deviation; and
...
3. D. Grier, H. Pashayan, and L. Schaeffer, “Sample-optimal classical shadows
   for pure states,” arXiv:2211.11810v2, Sections 4.2.1--4.2.2,
   <https://arxiv.org/abs/2211.11810v2>.

The first two are load-bearing. The third is a corroborating application and
must not replace direct reconstruction of the first two.
...
```text
QUESTION:                     FROZEN IN THIS PRIVATE DRAFT
